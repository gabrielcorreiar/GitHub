...
class Playlist:##herança - herdando o comportamento da classe list
    ...
    def __getitem__(self, item):##metodo mágica -> Próprio do lingugem
        return self._programas[item] ##A partir disso consegue montar um iteravel para uma lista
...
print(f'Tem ou não? {better_call_saul in playlist_fim_de_semana}')##Preciso por o (f') para poder passar parâmetros